...
from flask_jwt_extended import jwt_required, get_jwt_identity, get_jwt, create_access_token # pip install Flask_JWT_Extended
...
# @application.route('/api/changePassword', methods=['POST'])
# @jwt_required()
# def change_password():
#   current_user_email = get_jwt_identity()
