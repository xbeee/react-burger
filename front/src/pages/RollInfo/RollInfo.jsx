...
import "./RollInfo.css"; // Подключаем файл со стилями
	...
	return (
		<div className="container">
			<div className="roll-info">
				<h1 className="roll-info__title">Добро пожаловать в React Roll!</h1>
				<p className="roll-info__description">
					Мы рады приветствовать вас в нашем ресторане React Roll. Здесь вы найдете самые вкусные и качественные роллы, приготовленные с любовью и из лучших ингредиентов.
				</p>
				...
				<div className="roll-info__highlights">
					<h2 className="roll-info__highlight-title">Почему React Roll:</h2>
